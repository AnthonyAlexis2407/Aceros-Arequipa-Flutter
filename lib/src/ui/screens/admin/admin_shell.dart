      ...
      drawer: Drawer(
        child: Column(
          children: [
                  ...
                  children: [
                    ...
                    StreamBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final name = data['name'] ?? 'Administrador';
            ...
            ListTile(
              leading: const Icon(Icons.dashboard, color: Color(0xFF0A3D91)),
            ...
            ListTile(
              leading: const Icon(Icons.inventory_2, color: Color(0xFF0A3D91)),
            ...
            ListTile(
              ...
              title: const Text('Carrito de Carga'),
              onTap: () {
                Navigator.pop(context);
